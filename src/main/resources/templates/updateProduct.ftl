                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm1" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="cname" name="name" minlength="2" type="text" class="form-control"
                                           required="" aria-required="true" value="${product.name!""}">
                                </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <#list classifyList as list>
                                            <#if list.type==1>
                                                <option value="${list.id}"
                                                        <#if product.level1Id==list.id >selected</#if>>${list.name}</option>
                                            </#if>
                                        </#list>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="color" class="form-control" name="color" required=""
                                           aria-required="true" value="${product.color!""}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="count" class="form-control" name="count" required=""
                                           aria-required="true" value="${product.count!""}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="price" class="form-control" name="price" required=""
                                           aria-required="true" value="${product.price!""}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">商品描述：</label>
                                <div class="col-sm-8">
                                    <input value="${product.description!""}" type="hidden" id="des">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" name="file" title="选择商品图片" class="btn"
                                           value="${product.fileAddress!""}">
                                    <img src="${product.fileAddress!""}" width="20%" height="20%">
                                </div>
                            </div>
                            <div class="form-group">
