                    ...
                    <div>
                        <div class="ibox-content profile-content ">
                            ...
                            <div class="user-button">
                                <div class="row">
                                    <div class="col-md-8">
                                        <button type="button" id="btnUpdate" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#updateManager">编辑信息</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <label>管理员CODE：</label>
                        <div>
                            <input id="managerCode" class="form-control" name="managerCode" required="" aria-required="true" placeholder="管理员CODE" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>管理员姓名：</label>
                        <div>
                            <input id="managerName" class="form-control" name="managerName" required="" aria-required="true" placeholder="管理员姓名" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>手机号码：</label>
                        <div>
                            <input id="phone" name="phone"  class="form-control"  required="" aria-required="true" placeholder="管理员手机号码" value="">
                        </div>
                    </div>
                </div>
